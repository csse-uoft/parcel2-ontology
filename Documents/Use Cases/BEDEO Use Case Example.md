...
Documents related to examples of requests for expression of interest can be found here: https://drive.google.com/drive/folders/1uKWbMjASK2HksH8YvT0o01qMsU6YGoEZ?dmr=1&ec=wgc-drive-globalnav-goto  
...
https://broadview.org/united-church-regent-park/
https://www.toronto.ca/legdocs/mmis/2008/ah/bgrd/backgroundfile-12070.pdf
- Address: 40 Oak Street, Toronto, Ontario 
- Existing land use:  
- Site Owner: Toronto United Church Council 
- Size: 10,000 sq. ft. 
- Other info: Toronto United Church Council will contribute the land through donation  
- Description: A future community hub for social services and grass roots organizations with an affordable housing component, to be included in the Regent Park redevelopment. 
- Existing partners: Toronto Christian Resource Centre; Toronto United Church Council 
...
- Land Owner: City of Toronto 
- Size: 60,000 sq. ft. 
- Other info: requires a heritage easement agreement, in which certain features of the building must be protected; remediate the contaminated soil (former streetcar repair facility) 
- Description: Wychwood Barns is dedicated to combine non-profit housing with a community cultural hub in a redeveloped former streetcar repair facility that dates from 1913-1921. The project could include deeply affordable live-work spaces, a community-run component, programming and administrative facilities for non-profit organizations, and a shared community space for events and festivals.  
- Operating Model: Will operate under a 50-year lease at $1 a year on self-sustaining model 
- Existing partners: City of Toronto 
- Partner gaps: Affordable Housing provider 
...
- Site Owner: Harhay Development 
- Size: 134,680 sq. ft. 
- Other info:  
- Description: Harhay Developments is seeking an affordable housing partner for a mixed-use building that will include condominium units and a commercial area facing Queen Street East.  
- Existing partners:  
...
- Existing land use:
- Proposed land use: Mixed-Use Residential
- Site Owner: Parkdale United Church
- Size: 55,000 sq. ft.
- Other info: Aging building components and rising utility costs may impact long-term affordability
- Description: The Parkdale United Church wishes to address the rising housing costs in the Parkdale community by building affordable housing and a worship space on the site, requiring the demolishing of the existing Parkdale Methodist Church. This will be a mixed-use project that includes affordable housing and a church on the ground floor. The project aims to be a model of sustainable, affordable social housing
...
- Site Owner: City of Toronto property 
- Size: 381,200 sq. ft. 
- Other info: includes a heritage component 
- Description: Eva’s Phoenix / Waterworks is a diverse mixed-use project that involves the revitalization of a former public utilities building to include Eva’s Phoenix transitional shelter for youth, a 299-unit residential condominium development with 15 affordable ownership homes, a YMCA, a public food hall, and an improved St. Andrew’s playground. 
...
- Project type: You must seek to create an affordable housing development 
- Minimum number of units: You must seek to create a development that includes a minimum of 495 units at the site. 
- Zoning-related: proposal is compliant with existing zoning requirements (e.g.,land use, building height) 
- Affordability: a minimum of 30% of total units have rents below 80% of the Median Market Rent in Ottawa  
- Energy efficiency requirement project is designed to meet or exceed one of the following options 
...
- Accessibility requirement : project is designed to meet or exceed one of the following options: 
...
- Financial viability requirement: project is designed to meet a minimum debt coverage ratio of 1.10. 
...
- Street Address of Site: 9620 100 Avenue 
- Posted: January 20, 2025 
- Submission Deadline: Awarded 
